...
- Android 系统动态壁纸列表显示专属双屏缩略图，并通过系统“设置…”入口进入主题选择页。
- 首次使用走系统壁纸确认；组件已启用后，选择主题即可即时切换，无需重复确认。
...
产物位于 `release/双屏壁纸-v1.1.2-release.apk`。

## 安装与打开

```bash
adb install -r release/双屏壁纸-v1.1.2-release.apk
```
